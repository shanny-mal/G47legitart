  ...
  return (
    <footer className="relative bg-gradient-to-tr from-slate-900 via-indigo-900 to-rose-900 text-slate-100 py-10 sm:py-12">
      ...
      <div className="max-w-7xl mx-auto px-6">
        {/* grid: stacks on mobile, 3 cols on md+ */}
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 md:items-start">
          ...
          {/* Newsletter - on small screens: stack vertically, on md+: inline */}
          <div>
            <form
              onSubmit={subscribe}
